...
const ModalUpdateCarrier = ({ visible, onCancel, ...rest }) => {
  const { Item } = Form;
  return (
    <Modal
      ...
      onCancel={onCancel}
      width={850}
      className="default-modal carrier-modal"
    >
      <Form className="update-partner-form">
        <div className="update-info">
          <Row gutter={[24, 8]}>
            <Col span={12}>
              <div>
                <FormItem label="Mã ĐTGH" addClass="partner-code">
                  <Item name="code" initialValue="Mã mặc định">
                    <InputString />
                  </Item>
                </FormItem>
                <FormItem label="Tên ĐTGH">
                  <Item name="name">
                    <InputString />
                  </Item>
                </FormItem>
...
export default ModalUpdateCarrier;
