...
import CardPurchaseOrder from "../card/CardPurchaseOrder";
    ...
    <Fragment>
      <div className="btn-action">
        <Button
          ...
          onClick={()=>history.push("/purchase-order/screen")}
        >
          Nhập hàng
        </Button>
      </div>
        ...
        <Row gutter={[16, 8]} wrap>
          <Col lg={5} sm={8}>
            <div className="default-custom-left">
              <span className="title-default-custom">Phiếu nhập hàng</span>
